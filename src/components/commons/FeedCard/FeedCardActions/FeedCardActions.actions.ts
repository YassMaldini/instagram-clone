...
export const likeMutation = async ({ mediaId, _uid, _uuid }: MediaMutationVariables) => {
  const form = {
...
export const unlikeMutation = async ({ mediaId, _uid, _uuid }: MediaMutationVariables) => {
  const form = {
    inventory_source: 'media_or_ad',
    delivery_class: 'organic',
    tap_source: 'button',
...
export const saveMutation = async ({ mediaId, _uid, _uuid }: MediaMutationVariables) => {
  const form = {
    inventory_source: 'media_or_ad',
    delivery_class: 'organic',
    tap_source: 'button',
...
export const unsaveMutation = async ({ mediaId, _uid, _uuid }: MediaMutationVariables) => {
  const form = {
    inventory_source: 'media_or_ad',
    delivery_class: 'organic',
    tap_source: 'button',
