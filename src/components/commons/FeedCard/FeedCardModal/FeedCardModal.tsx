...
const FeedCardModal = forwardRef<any, any>((rest, ref) => {
        ...
        <Box
          ...
          <Box
            ...
            <FeedCardModalColumnButton
              ...
              label="Share"
            />
            <FeedCardModalColumnButton imageSource={LinkImage} label="Link" />
            <FeedCardModalColumnButton imageSource={SaveImage} label="Save" />
            <FeedCardModalColumnButton imageSource={CaptureImage} label="QR code" />
          </Box>
          <Box borderBottomWidth={1} borderBottomColor="elevatedSeparator">
            <FeedCardModalRowButton imageSource={StarImage} label="Add to favorites" />
