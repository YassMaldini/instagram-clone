...
const SignInLanguagePicker = () => {
  ...
  return (
    <Box>
      <TouchableOpacity style={{ marginTop: theme.spacing.s, marginBottom: theme.spacing.xxl }} onPress={() => setModalVisible(true)}>
        <Box
          flexDirection='row'
          alignItems='center'
          ...
          <Box flex={1} paddingHorizontal="xl" paddingVertical="s">
            <TouchableWithoutFeedback>
              <Box flex={1} backgroundColor={"highlightBackground"}>
                ...
                >
                  <Text fontSize={20} fontWeight='bold'>{t('header')}</Text>
                </Box>
              {
