    ...
    <Box flexDirection="row" alignItems="center" padding="m">
      ...
      <Box flex={1}>
        ...
        <Box flexDirection="row" marginTop="xs">
          ...
          <Text fontSize={13} fontWeight="800" color="secondaryText" marginRight="m">{commentItem.comment_like_count} likes</Text>
          <Text fontSize={13} fontWeight="800" color="secondaryText">Reply</Text>
        </Box>
      </Box>
