export interface UserInfoResponseRootObject {
  user: UserInfoResponseUser;
  status: string;
}
export interface UserInfoResponseUser {
  pk: number;
  username: string;
  full_name: string;
  is_private: boolean;
  ...
  biography_with_entities: UserInfoResponseBiography_with_entities;
  external_url: string;
  ...
  hd_profile_pic_versions: UserInfoResponseHdProfilePicVersionsItem[];
  hd_profile_pic_url_info: UserInfoResponseHd_profile_pic_url_info;
  ...
  nametag: UserInfoResponseNametag;
...
export interface UserInfoResponseBiography_with_entities {
  raw_text: string;
  entities: any[];
}
export interface UserInfoResponseHdProfilePicVersionsItem {
  width: number;
  height: number;
  url: string;
}
export interface UserInfoResponseHd_profile_pic_url_info {
  url: string;
  width: number;
  height: number;
}
export interface UserInfoResponseNametag {
  mode: number;
  gradient: number;
  emoji: string;
